---
title: "How to Build a B2B Lead List Without Expensive Tools"
...
faqs:
  ...
  - question: "How many leads do I need for a cold email campaign?"
    answer: "For Signal-Led GTM, you need 50-100 highly targeted leads per campaign, not thousands. Quality targeting at low volume consistently outperforms high-volume generic outreach."
  - question: "What data do I need for each lead?"
    answer: "At minimum: name, email (verified), company, title, and the signal that triggered their inclusion. Optional but valuable: company size, tech stack, recent news, and LinkedIn profile URL."
  - question: "Should I buy lead lists?"
    answer: "No. Purchased lists are generic, outdated, and often contain invalid emails that damage your sender reputation. Build lists yourself based on real-time signals for dramatically better results."
relatedPosts:
  - "defining-your-icp"
...
50 signal-matched leads will outperform 5,000 demographic-filtered contacts. That's the foundation of [The Signal Stack](/framework).
